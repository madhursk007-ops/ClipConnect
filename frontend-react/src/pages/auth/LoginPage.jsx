    ...
    return (
      ...
      >
        <div className="text-center">
          ...
          <h2 className="text-3xl font-heading font-bold mb-4">Welcome Back!</h2>
          ...
          >
            ...
            <div className="grid grid-cols-2 gap-4">
              <motion.button
                ...
                className="flex items-center justify-center px-4 py-2 border border-white/20 rounded-xl hover:bg-white/5 transition-colors"
              >
